...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateLabel(LabelText)
			local LabelValue = {CurrentValue = ""}

			local Label = Elements.Template.Label:Clone()
			Label.Title.Text = LabelText.CurrentValue
			Label.Visible = true
			...
			function LabelValue:Set(NewLabel)
				...
				LabelValue.CurrentValue = NewLabel
				LabelText.CurrentValue = NewLabel
				SaveConfiguration()
			end
			
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and LabelText.Flag then
					RayfieldLibrary.Flags[LabelText.Flag] = LabelValue
				end
			end
